...
describe('blogs', () => {
    ...
    describe('most', () => {
        ...
        test('of many is calculated right', () => {
            assert.deepStrictEqual(listHelper.mostBlogs(blogs), { author: blogs[3].author, blogs: 3 })
        })
    ...
    describe('likes', () => {
        ...
        test('of one value is the value itself', () => {
            assert.deepStrictEqual(listHelper.mostLikes([blogs[0]]), { author: blogs[0].author, likes: 7 })
        })

        test('of many is calculated right', () => {
            assert.deepStrictEqual(listHelper.mostLikes(blogs), { author: blogs[1].author, likes: 17 })
        })
